...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { dob: @child.dob, first_name: @child.first_name, last_name: @child.last_name } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { dob: @child.dob, first_name: @child.first_name, last_name: @child.last_name } }
